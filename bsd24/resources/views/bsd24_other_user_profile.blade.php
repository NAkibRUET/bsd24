...
@section('dynamic_page')
	...
	<!--Please, place all your div/box/anything inside the above SECTION-->
		...
		@forelse ($user_data as $data)
	    	<input type="hidden" id="hiddenName" name="fullName" value="{{ $data->full_name }}">
	    @empty
    		<input type="hidden" id="hiddenName" name="fullName" value="??">
		@endforelse
				...
				<div class="col-md-12">
					...
					<div style="font-family: Helvetica; background: white; border: 1px solid #e5e5e5; margin-top: 10px; ">
						...
						<div class="profileInfo">
							...
							@forelse ($user_data as $data)
								<h2 style="text-align: center; color: #1B6DC1;">{{$data->full_name}}</h2>
								<h6 style="text-align: center; color: #7f7f7f;">Email: {{ $data->user_email }}</h6>
								<h6 style="text-align: center; color: #7f7f7f;">Mobile: {{$data->user_phone}}</h6>
							@empty
								<h2 style="text-align: center; color: #7f7f7f;">No user found with this email</h2>
							@endforelse
